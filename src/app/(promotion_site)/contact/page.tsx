...
export const metadata: Metadata = {
    ...
    description:
        "Get in touch with us. Do you have probles or questions? Feel free to contact us in the form below. Or check our email and other socials where you can reach us.",
};
