...
export const insertSiteNavbarSchema = createInsertSchema(siteNavbars).omit(timestamps);
export const insertSiteNavbarParams = baseSchema.extend({
...
export type CompleteSiteNavbar = Awaited<ReturnType<typeof getSiteNavbars>>["siteNavbars"][number];
